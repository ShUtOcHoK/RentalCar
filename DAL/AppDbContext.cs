    ...
    public class AppDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Car.Car>().HasData(
              new Car.Car { Id = 1, Name= "Ford", Number="CB234P", Year=2001, CarStatus_Id= 1, CarType_Id= 1, BasePrice=1500 },
              new Car.Car { Id = 2, Name = "Honda", Number = "CE254P", Year = 2020, CarStatus_Id = 2, CarType_Id= 2, BasePrice =700  },
              new Car.Car { Id = 3, Name = "Jeep", Number = "BB238P", Year = 2015, CarStatus_Id = 2, CarType_Id = 1, BasePrice =1000  },
              new Car.Car { Id = 4, Name = "Nissan", Number = "CP634P", Year = 2007, CarStatus_Id =1, CarType_Id =2 , BasePrice =600  },
              new Car.Car { Id = 5, Name = "Toyota", Number = "CX294P", Year = 2009, CarStatus_Id =1, CarType_Id =2 , BasePrice =650 },
              new Car.Car { Id = 6, Name = "Lada", Number = "CA847T", Year = 2019, CarStatus_Id =1, CarType_Id = 2 , BasePrice = 800 }
